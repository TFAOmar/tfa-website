...
const Contact = () => {
  ...
  return (
    <>
      <SEOHead
        title="Contact Us"
        description="Get in touch with The Financial Architects. Call (888) 350-5396, email us, or visit one of our 32 office locations across California, Arizona, and Oregon."
