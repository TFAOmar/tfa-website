  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background text-foreground antialiased">
        ...
        <header className="sticky top-0 z-40 border-b border-border/60 bg-background/85 backdrop-blur supports-[backdrop-filter]:bg-background/70">
          <div className="container mx-auto flex items-center justify-between px-4 py-3">
            <div className="flex items-center gap-2">
              <div className="flex h-9 w-9 items-center justify-center rounded-md bg-primary text-primary-foreground font-bold tracking-tight">
                TFA
              </div>
            ...
            <Button size="sm" onClick={scrollToApply} className="bg-primary text-primary-foreground hover:bg-primary/90">
              Apply to Connect
            </Button>
          </div>
        </header>
        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-primary via-primary to-primary/90 text-primary-foreground">
          ...
          <div className="container relative mx-auto grid gap-12 px-4 py-16 lg:grid-cols-2 lg:items-center lg:py-24">
            <div className="space-y-6">
              <Badge className="inline-flex items-center gap-1.5 border-accent/40 bg-accent/15 text-accent hover:bg-accent/20">
                <Instagram className="h-3.5 w-3.5" />
                From Instagram @4am.omar
              </Badge>
              <h1 className="text-4xl font-bold leading-[1.05] tracking-tight sm:text-5xl lg:text-6xl">
                Build Your Career in Financial Services With The Financial Architects
              </h1>
              <p className="max-w-xl text-lg text-primary-foreground/80 sm:text-xl">
                Connect with Omar Sanchez, COO of The Financial Architects, and learn what it takes to grow in financial services through leadership, sales, systems, and a serious team environment.
              </p>
              ...
              <p className="max-w-md text-sm text-primary-foreground/60">
                No hype. No income promises. Just a real conversation about fit, standards, training, and opportunity.
              </p>
            </div>

            <div className="relative mx-auto w-full max-w-md lg:ml-auto">
              <div className="absolute -inset-3 rounded-3xl bg-accent/20 blur-2xl" />
              <div className="relative overflow-hidden rounded-3xl border border-primary-foreground/10 shadow-2xl">
                <img
                  src={omarImage}
                  alt="Omar Sanchez, COO of The Financial Architects"
                  className="aspect-[4/5] w-full object-cover"
                />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-primary via-primary/80 to-transparent p-5">
                  <p className="text-xs uppercase tracking-widest text-accent">Replace with Omar headshot or TFA event photo</p>
                </div>
              </div>
              <Card className="absolute -bottom-6 left-4 right-4 border-border/40 bg-background/95 shadow-xl backdrop-blur sm:left-auto sm:right-[-1rem] sm:w-72">
                <CardContent className="p-4">
                  <p className="text-base font-semibold text-foreground">Omar Sanchez</p>
        ...
        {/* Intro Video */}
        <section id="video" className="bg-background py-20">
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-4xl">
              <p className="text-sm font-semibold uppercase tracking-widest text-accent">Start Here</p>
              <h2 className="mt-2 text-3xl font-bold tracking-tight sm:text-4xl">
                A quick message from Omar
              </h2>
              <p className="mt-3 max-w-2xl text-muted-foreground">
                Before you apply, watch this quick message from Omar about what The Financial Architects is building and who this opportunity is best suited for.
              </p>

              {/* Video placeholder — swap inner content with <iframe> or <video> when ready */}
              <div className="mt-8 aspect-video w-full overflow-hidden rounded-2xl border border-border bg-secondary/40">
                <div className="flex h-full w-full flex-col items-center justify-center gap-3 text-center">
                  <div className="flex h-16 w-16 items-center justify-center rounded-full bg-primary/10">
                    <Play className="h-7 w-7 text-primary" />
                  </div>
                  <p className="text-sm font-medium text-foreground">Add Omar intro video here</p>
                  <p className="max-w-md px-6 text-xs text-muted-foreground">
                    Suggested script: "What's up, I'm Omar Sanchez, COO at The Financial Architects. If you found me through Instagram, this page is for people interested in building in financial services, developing as leaders, and being around a team focused on sales, systems, culture, and real execution. If that sounds like you, fill out the form below and we'll connect."
                  </p>
                </div>
              </div>

              <div className="mt-8 flex justify-center">
                <Button size="lg" onClick={scrollToApply} className="bg-primary text-primary-foreground hover:bg-primary/90">
                  Apply to Connect
                  <ArrowRight className="ml-2 h-4 w-4" />
                </Button>
              </div>
        ...
        <section className="border-t border-border/60 bg-secondary/30 py-20">
          <div className="container mx-auto grid gap-12 px-4 lg:grid-cols-5 lg:items-center">
            <div className="lg:col-span-3">
              <p className="text-sm font-semibold uppercase tracking-widest text-accent">Meet Omar Sanchez</p>
              <h2 className="mt-2 text-3xl font-bold tracking-tight sm:text-4xl">
            ...
            <Card className="lg:col-span-2 border-border/60 bg-background shadow-lg">
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-2xl text-center">
              <p className="text-sm font-semibold uppercase tracking-widest text-accent">Fit</p>
              <h2 className="mt-2 text-3xl font-bold tracking-tight sm:text-4xl">
            ...
            <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
              {fitItems.map((item) => (
                <Card key={item.title} className="border-border/60 transition hover:border-accent/40 hover:shadow-md">
            ...
            <Card className="mx-auto mt-8 max-w-3xl border-destructive/30 bg-destructive/5">
              <CardContent className="flex items-start gap-4 p-6">
                <AlertTriangle className="mt-0.5 h-5 w-5 shrink-0 text-destructive" />
                <p className="text-sm font-medium text-foreground">
                  This is not for someone looking for easy money, shortcuts, or guaranteed results.
                </p>
              </CardContent>
            </Card>
          </div>
        ...
        <section className="border-t border-border/60 bg-secondary/30 py-20">
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-2xl text-center">
              <p className="text-sm font-semibold uppercase tracking-widest text-accent">What We Focus On</p>
              <h2 className="mt-2 text-3xl font-bold tracking-tight sm:text-4xl">
            ...
            <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
              {focusCards.map((card) => (
                <Card key={card.title} className="border-border/60 bg-background transition hover:shadow-md">
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
              {processSteps.map((step) => (
                <div key={step.n} className="rounded-2xl border border-border/60 bg-background p-6">
                  <div className="text-sm font-bold tracking-widest text-accent">{step.n}</div>
        ...
        <section className="bg-primary py-20 text-primary-foreground">
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-2xl text-center">
              <p className="text-sm font-semibold uppercase tracking-widest text-accent">Standards Over Hype</p>
              <h2 className="mt-2 text-3xl font-bold tracking-tight sm:text-4xl">
                Built the right way.
              </h2>
              <p className="mt-3 text-primary-foreground/75">
                The Financial Architects is focused on building people the right way — through training, consistency, mentorship, and execution. This is for people who want to be challenged, developed, and held to a higher standard.
              </p>
            </div>
            <div className="mt-12 grid gap-4 sm:grid-cols-2">
              {standards.map((s) => (
                <div
                  key={s}
                  className="rounded-2xl border border-primary-foreground/15 bg-primary-foreground/5 p-6 text-lg font-semibold tracking-tight"
                >
                  {s}
                </div>
              ))}
        ...
        {/* Form */}
        <section id="apply" ref={formRef} className="py-20">
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-3xl">
              <div className="text-center">
                <p className="text-sm font-semibold uppercase tracking-widest text-accent">Apply</p>
                <h2 className="mt-2 text-3xl font-bold tracking-tight sm:text-4xl">
                  Apply to Connect with Omar and TFA
                </h2>
                <p className="mt-3 text-muted-foreground">
                  Tell us a little about yourself. If there is alignment, we will reach out with next steps.
                </p>
              </div>

              {submitted ? (
                <Card className="mt-10 border-accent/30 bg-background shadow-lg">
            ...
            <div className="grid gap-10 lg:grid-cols-3">
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-semibold">The Financial Architects</span>
                </div>
              ...
              <div className="lg:col-span-2">
                <Button onClick={scrollToApply} className="bg-primary text-primary-foreground hover:bg-primary/90">
                  Apply to Connect
                  <ArrowRight className="ml-2 h-4 w-4" />
                </Button>
        ...
        {/* Mobile sticky CTA */}
        <div className="fixed inset-x-0 bottom-0 z-50 border-t border-border bg-background/95 p-3 shadow-[0_-4px_20px_rgba(0,0,0,0.08)] backdrop-blur lg:hidden">
          <Button
            size="lg"
            onClick={scrollToApply}
            className="w-full bg-primary text-primary-foreground hover:bg-primary/90"
